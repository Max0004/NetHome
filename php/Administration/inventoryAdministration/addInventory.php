...
<body><!--"Work in Progress"-->
	...
	<div class="contentbox">
		<input type="button" value="Zurück zur Übersicht" style="width: 15em; height: 3em;" onclick="window.location.href='../../../html/adminControl.html'"/><br>	<!--Kehrt zur Kontrollfläche zurück-->
	</div>
</body>
</html>